...
export default function Phone({ children }: Props) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='relative aspect-[366/729] mx-auto max-w-[320px]'>
      <div className='shadow-sm absolute inset-y-[calc(1/729*100%)] right-[calc(5/729*100%)] left-[calc(7/729*100%)] rounded-[calc(58/366*100%)/calc(58/729*100%)]'></div>
